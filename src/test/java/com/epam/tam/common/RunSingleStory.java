...
public class RunSingleStory extends JUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        ApplicationContext context = new SpringApplicationContextFactory("config.xml").createApplicationContext();
    ...
    protected List<String> storyPaths() {
        return new StoryFinder().findPaths(codeLocationFromClass(this.getClass()).getFile(),
                asList("**/" + System.getProperty("storyFilter", runTest())), null);
    }

    private String runTest() {
        return Property.STORY;
    }
}
